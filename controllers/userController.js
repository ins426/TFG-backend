...
async function deleteUser(req,res) {
     ...
     if(req.user.rol == 'administrador'){
         ...
         await Appointment.deleteMany({id_psychologist: idUser})
    ...
    if(user != []){
      const token = jwt.sign({'email': req.body['email']}, process.env.AUTH_TOKEN_SECRET,
        ...
        const mailData = {
            ...
            '          <tr>\n' +
            '            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: \'Source Sans Pro\', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">\n' +
            '              <p style="margin: 0;">Haz click sobre el boton de abajo para restablecer tu contraseña. Si este correo electrónico no iba dirigido a ti, puedes borrar de forma segura este email.</p>\n' +
            '            </td>\n' +
            '          </tr>\n' +
            '          <!-- end copy -->\n' +
            '\n' +
            ...
            '                      <tr>\n' +
            '                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">\n' +
            '                          <a href="https://localhost:4200/restablecer-contrasenia?token=' + token + '" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: \'Source Sans Pro\', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; background-color: #009FB7; text-decoration: none; border-radius: 6px;">Restablecer contraseña</a>\n' +
            '                        </td>\n' +
            '                      </tr>\n' +
            '                    </table>\n' +
            '                  </td>\n' +
            ...
            '          <tr>\n' +
            '            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: \'Source Sans Pro\', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">\n' +
            '              <p style="margin: 0;">También puedes utilizar el siguiente enlace para restablecer tu contraseña:</p>\n' +
            '              <a href="https://localhost:4200/activar-cuenta?token=' + token + '" target="_blank">https://localhost:4200/restablecer-contrasenia?token=' + token + '</a>\n' +
            '            </td>\n' +
            '          </tr>\n' +
            '          <!-- end copy -->\n' +
            '\n' +
...
deleteUser,  editPsychologist, changePassword,forgetPassword}